...
| 区間名                        | 推奨power値 | 理由・備考                                   |
|-------------------------------|-------------|----------------------------------------------|
| 直線区間1                     | 70～80      | STRAIGHT_POWER。最高速重視。安全マージン要調整。|
| オブスタクルボトル(黄)         | 40～55      | BASE_POWER。ボトル検知・回避。                |
| 障害物区間                    | 40～55      | BASE_POWER～やや高め。障害物回避・安定性重視。|
| 直線区間2                     | 70～80      | STRAIGHT_POWER。再加速。                      |
| 90度カーブ1（右）             | 35～45      | BASE_POWER。脱線しない範囲。                 |
| 直線区間3                     | 70～80      | STRAIGHT_POWER。加速。                        |
| 90度カーブ2（右）             | 35～45      | BASE_POWER。脱線しない範囲。                 |
| 直線区間4                     | 70～80      | STRAIGHT_POWER。加速。                        |
| ループ進入開始（A→B・右カーブ）| 30～40      | CURVE_POWER。進入時減速・安定走行。           |
| 交差点B→B（左カーブ）         | 30～40      | CURVE_POWER。ループ内左カーブ・最徐行。       |
| 交差点B→A（右カーブ・合流）    | 30～40      | CURVE_POWER。ループ出口・右カーブ・合流。     |
| 直線区間5（合流後）            | 70～80      | STRAIGHT_POWER。合流後加速。                  |
| キャリーボトル1(赤)            | 30～45      | BASE_POWER。ボトル検知・運搬。                |
| スマートキャリー1              | 30～45      | BASE_POWER。減速・安定走行・ゲート通過。      |
| キャリーボトル2(青)            | 30～45      | BASE_POWER。ボトル検知・運搬。                |
| スマートキャリー2              | 30～45      | BASE_POWER。減速・安定走行・ゲート通過。      |
