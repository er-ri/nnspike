...
| キャリーボトル（赤・青）        | 30～45      | BASE_POWER。ボトル検知・運搬。                |
| スマートキャリー（1・2）        | 30～45      | BASE_POWER。減速・安定走行・ゲート通過。      |
...
| 3   | 障害物区間                    | オブスタクルボトル(黄)  | 直線区間2(S2)           | 30～40     | 障害物回避・安定性重視                  | CURVE_POWER         |
| 4   | 直線区間2                     | 障害物区間(OB)          | 90度カーブ1(C1)         | 70～80     | 再加速                                  | STRAIGHT_POWER      |
| 5   | 90度カーブ1（右）             | 直線区間2(S2)           | 直線区間3(S3)           | 30～40     | 脱線防止・減速                          | CURVE_POWER         |
| 6   | 直線区間3                     | 90度カーブ1(C1)         | 90度カーブ2(C2)         | 70～80     | 加速                                    | STRAIGHT_POWER      |
| 7   | 90度カーブ2（右）             | 直線区間3(S3)           | 直線区間4(S4)           | 30～40     | 脱線防止・減速                          | CURVE_POWER         |
