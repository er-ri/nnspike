...
2.  Upload `spike/slot2.py` to LEGO SPIKE Prime Hub through [**SPIKE Legacy App**](https://education.lego.com/en-us/downloads/spike-legacy-app/software/) or the VSCode plugin [**LEGO SPIKE Prime / MINDSTORMS Robot Inventor Extension v1.6.1**](https://marketplace.visualstudio.com/items?itemName=PeterStaev.lego-spikeprime-mindstorms-vscode).
