    ...
    def fast_lap(self, image: np.ndarray) -> Tuple[Optional[float], Optional[SpeedTuple], Mode]:
        ...
        if phase.get_phase() == 0:
            ...
            if position_diff < 5400:
                left_speed, right_speed = et.yaw_straight_control(base_speed=HIGH_SPEED_BASE,adjust_speed=10)
        ...
        # フェーズ5: 左旋回90度判定（ここでは90度）。到達で次フェーズ、基準yawをstart_yaw-90に更新
        ...
        # フェーズ7: 左旋回90度判定。到達で次フェーズ、基準yawをstart_yaw-180に更新
