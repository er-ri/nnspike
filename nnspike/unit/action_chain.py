    ...
    def test_mode_action(self, image=None) -> Tuple[Tuple[int, int], Mode]:
        ...
        if phase.get_phase() == 1:
            ...
            if position_diff < 390:
                ...
                #     et.set_start_yaw(et.get_start_yaw() + 90.0)
                et.set_start_yaw()
                print(f"[DEBUG] mode={Mode.TEST.value} | phase={phase.get_phase()} | turn position_diff={position_diff} >= 390 | start_yaw={et.get_start_yaw():.2f} | current_yaw=PHASE_CHANGE | proceed to phase2")
                phase.next_phase(current_pos)
                return (0, 0), Mode.TEST
        ...
        if phase.get_phase() == 3:
            ...
            if position_diff < 390:
                ...
                #     et.set_start_yaw(et.get_start_yaw() + 90.0)
                et.set_start_yaw()
                print(f"[DEBUG] mode={Mode.TEST.value} | phase={phase.get_phase()} | turn position_diff={position_diff} >= 390 | start_yaw={et.get_start_yaw():.2f} | current_yaw=LOOP | proceed to phase0")
