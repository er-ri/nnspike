...
#   400  |      30         |    213
#   430  |       0         |    165
# ※y<=30: 1200固定, 30<y<=250: 線形補間(1200→500), 250<y<=350: 線形補間(420→360), それ以外: int(1.6*distance+165)
    ...
    if distance > 0:
        if top_y <= 30:
            ...
            # 250〜350 線形補間（傾き調整: 300で430, 350で370）全体+10
            practical_distance = int(430 + (370-430)*(top_y-300)/50)
        else:
            slope = 1.6
            intercept = 165
