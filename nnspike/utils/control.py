...
#   400  |      32         |    216
#   432  |       0         |    165
# ※y<=30: 1200固定, 30<y<=250: 線形補間(1200→500), 250<y<=350: 線形補間(600→500), それ以降: int(1.6*distance+165)
    ...
    if distance > 0:
        if top_y <= 30:
            ...
            # 250〜350 線形補間 (y=250で610, y=350で510)
            practical_distance = int(610 + (510-610)*(top_y-250)/(350-250))
        else:
            slope = 1.6
            intercept = 165
