...
class SensorRecorder:
    ...
    def log_frame_data(self, spike_status, mode=None, left_speed=0, right_speed=0) -> None:
        ...
        row_data = [
            ...
            self._safe_get(sensors.gyroscope.x if sensors.gyroscope else None, 0.0),
            self._safe_get(sensors.gyroscope.y if sensors.gyroscope else None, 0.0),
            self._safe_get(sensors.gyroscope.z if sensors.gyroscope else None, 0.0),
            ...
            self._safe_get(sensors.yaw_pitch_roll.x if sensors.yaw_pitch_roll else None, 0.0),
            self._safe_get(sensors.yaw_pitch_roll.y if sensors.yaw_pitch_roll else None, 0.0),
            self._safe_get(sensors.yaw_pitch_roll.z if sensors.yaw_pitch_roll else None, 0.0),
