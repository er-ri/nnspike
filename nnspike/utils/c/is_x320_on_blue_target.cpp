...
// 画像中央付近で青ターゲット抽出
bool is_x320_on_blue_target(py::array image_np, int x_tolerance = 60) {
...
PYBIND11_MODULE(control_cpp_x320_blue, m) {
    m.def("is_x320_on_blue_target", &is_x320_on_blue_target, "Is x=320 on blue target", py::arg("image"), py::arg("x_tolerance") = 60);
}
