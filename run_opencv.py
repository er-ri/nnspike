...
BASE_POWER = 50                    # カーブ時の基準パワー 40→45にUP
STRAIGHT_POWER = 100               # 直線時の推奨パワー 50→60にUP
CURVE_POWER = 30                   # 急カーブ時の最低パワー 30→35にUP
...
MAX_POWER_DIFF = 40       # 最大旋回時の左右パワー差（%） 45→55にUP
MAX_THETA_DEG = 50        # 最大旋回角（度数法, 55→65度にUP）
